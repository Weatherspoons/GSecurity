...
$triggerRandomPassword.RepetitionInterval = New-TimeSpan -Minutes 10  # Repeat every 10 minutes
$triggerRandomPassword.RepetitionDuration = New-TimeSpan -Days 999   # Repeat for 999 days
